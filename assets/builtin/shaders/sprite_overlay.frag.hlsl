// Overlay sprite fragment shader.
//
// Identical to builtin/shaders/sprite.frag.hlsl — the overlay pass reuses the same
// SpriteFS uniform layout. Samples the bound texture and multiplies by the per-draw tint.
// If outline_width > 0, transparent texels (a <= alpha_threshold) that have any opaque
// neighbor are painted with outline_color. With outline_width == 0 this degenerates to a
